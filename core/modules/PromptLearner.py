...
class PromptLearner(nn.Module):
    def __init__(self, cfg, classnames, clip_model, text_encoder_model):
        ...
        self.mylogger.info(f"Number of context words (tokens): {n_ctx}")
        ...
        self.construct_references_lasp(cfg, clip_model, text_encoder_model, classnames, dtype)
    ...
    def construct_references_lasp(self, cfg, clip_model, text_encoder_model, all_classnames, dtype):
        self.mylogger.info('Initializing LASP prompts...')
